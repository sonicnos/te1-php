...
<body>
  ...
  <section class="home">
    ...
    <div class="description">
      ...
      <p>En argot de Helsinki, la ville est aussi appelée Stadi (du suédois stad, ville) et Hesa en finnois familier.</p>
    </div>
    <!-- TO DO make other link between section -->
    <p class="source">Source: <a href="https://fr.wikipedia.org/wiki/Helsinki">Wikipedia</a></p>
  </section>
</body>
